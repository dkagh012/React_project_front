...
function UserDeleteAction(props) {
  ...
  return (
    <div className={classes.UserDeleteAction_wrap}>
      <div
        className={classes.UserDeleteActionBack}
        ...
        {showSuccess ? (
          <div className={classes.UserDeleteClose}>
            <div>
              ...
              <span>
                탈퇴 신청한 계정은 탈퇴 처리 될 때까지 사용 불가합니다
              </span>
            ...
            <div className={classes.InputBox}>
              ...
              <div className={classes.DeleteForm} ref={dropdownRef}>
                <div className={classes.DeleteValue}>
                  ...
                  <button onClick={handleListOpen} type="button">
                    {selectedReason || "탈퇴 사유 선택"}
                  </button>
                  <FaChevronDown />
                </div>
                {ShowInputList && (
                  <ul>
                    <li
                      onClick={() =>
                        handleReasonSelect("더 이상 이용하지 않음")
                      }
                    >
                      더 이상 이용하지 않음
                    </li>
                    <li
                      onClick={() => handleReasonSelect("다른 서비스 이용함")}
                    >
                      다른 서비스 이용함
                    </li>
                    <li onClick={() => handleReasonSelect("사용 빈도가 낮음")}>
                      사용 빈도가 낮음
                    </li>
                    <li
                      onClick={() =>
                        handleReasonSelect("이용이 불편하고 장애가 많음")
                      }
                    >
                      이용이 불편하고 장애가 많음
                    </li>
                    <li
                      onClick={() => handleReasonSelect("필요한 정보가 없음")}
                    >
                      필요한 정보가 없음
                    </li>
                  </ul>
              ...
              {UserDeleteNumberError && (
                <p className={classes.Error}>{UserDeleteNumberError}</p>
              )}
              <Button
                type="button"
                onClick={handleSave}
                disabled={!!UserDeleteNumberError && selectedReason === ""}
              >
                회원탈퇴
              </Button>
            </div>
