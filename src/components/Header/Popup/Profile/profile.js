  ...
  return (
    <div className={classes.Profile}>
      <ul className={classes.ProfileList}>
        ...
        <li><Link to="/business-info"><span>업체 정보</span></Link></li>
        <li><Link to="/visitors"><span>업체 방문자</span></Link></li>
        <li><Link to="/activity-log"><span>활동 로그</span></Link></li>
        <li><Link to="/subscription"><span>구독권 관리</span></Link></li>
      </ul>
    </div>
  )
}
